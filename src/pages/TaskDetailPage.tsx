  ...
  useEffect(() => {
    const fetchTask = async () => {
      ...
      setTask({
        ...
        assigned_to_name: (data.assigned_to_profile as any)?.full_name || null,
        reassignment_count: data.reassignment_count || 0,
